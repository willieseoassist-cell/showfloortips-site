...
### Stream 1: Digital Products (Target: $150,000/yr)

**Current products (19 items, $7.99 - $14.99):**
- Checklists ($7.99): Pre-Show, Booth Setup, Post-Show Teardown, Lead Follow-Up, Travel & Logistics
- Spreadsheets ($12.99): Budget & ROI Calculator, Lead Tracking, Vendor Comparison, Show Calendar, Booth Cost Estimator
- Email Packs ($9.99): Post-Show Follow-Up, Pre-Show Appointment, Thank You & Recap, VIP Invitation, Internal Team Brief
- Guides ($14.99): First-Time Exhibitor, Booth Design, Lead Capture Strategy, International Show, ROI Maximization

**What to add:**
- **Mega Bundle** — All 19 products for $49.99 (anchor price drives bundle sales)
- **Industry-Specific Kits** — "Healthcare Exhibitor Kit", "Tech Show Kit", etc. ($29.99 each)
- **Show-Specific Prep Packs** — Tailored to CES, NRF, HIMSS, etc. ($19.99 each)
- **Annual Exhibitor Planner** — Full-year calendar + budgets + templates ($39.99)

**Math:** 500 sales/month x $25 avg = $12,500/mo = **$150,000/yr**

---

### Stream 2: Premium Subscription (Target: $300,000/yr)

**"ShowFloorTips Pro" — $29/month or $249/year**

Features:
- Unlimited access to all digital products (currently sold individually)
- Advanced show filters (ROI predictions, competitor exhibitor lists, historical attendance trends)
- Priority show alerts — get notified when new shows in your industry are added
- Exhibitor benchmarking data (avg booth cost by industry, avg lead count)
- Downloadable exhibitor data (CSV exports of show lists)
- Exclusive "Pro" articles — deep-dive show reviews from past exhibitors
- Ad-free experience
- Early access to new tools

**Math:** 1,000 subscribers x $25/mo avg = $25,000/mo = **$300,000/yr**

---

### Stream 3: Scannly App Monetization (Target: $200,000/yr)

**Current:** Free app
**Upgrade to freemium model:**

- **Free tier:** 10 scans/show, basic contact export
- **Scannly Pro ($9.99/month):** Unlimited scans, CRM integrations (HubSpot, Salesforce), team sharing, analytics dashboard, custom branding on QR cards
- **Scannly Team ($29.99/month):** Up to 10 users, admin dashboard, lead scoring, real-time sync
- **Scannly Enterprise ($99/month):** Unlimited users, API access, SSO, priority support

**Math:** 1,500 paid users x $15/mo avg = $22,500/mo = **$200,000/yr** (grows with app store presence + website traffic)

---

### Stream 4: Affiliate Revenue (Target: $100,000/yr)

**Current:** Booking.com hotel links on show pages
**Expand to:**
...
- **Software tools** — HubSpot, Salesforce, Mailchimp affiliate programs (pay $50-$200 per signup)
- **Event management platforms** — Eventbrite, Cvent, Bizzabo
- **Credit cards** — Travel reward cards (Chase Sapphire, Amex Business) pay $100-$200 per approval

**Math:** 50,000 monthly visitors x 2% click-through x 5% conversion x $30 avg commission = $8,300/mo = **$100,000/yr**

---

### Stream 5: Sponsored Listings & Advertising (Target: $150,000/yr)

**Show organizers pay to be featured:**
- **Featured Show Listing** — Highlighted card on homepage + category pages ($500/month)
- **Sponsored Article** — Custom article about their show ($1,000 one-time)
- **Banner Ads** — Sidebar/header placement on high-traffic pages ($300/month per placement)
- **Newsletter Sponsorship** — Featured spot in weekly email ($500 per send)
- **"Official Partner" badge** — Show gets a verified badge on their listing ($2,000/year)
...
**Sell anonymized market intelligence to:**
- Show organizers wanting to benchmark against competitors
- Booth vendors wanting to reach exhibitors
- Marketing agencies targeting trade show companies

**Products:**
- **Industry Report** — "State of [Industry] Trade Shows 2026" ($299 each)
- **Custom Data Pulls** — Show lists filtered by criteria ($499 per report)
- **API Access** — Let companies query our show database ($199/month)

**Math:** ~$8,300/mo = **$100,000/yr**
